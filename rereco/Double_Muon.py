...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,ALCA:TkAlZMuMu+MuAlCalIsolatedMu+MuAlOverlaps+MuAlZMuMu+DtCalib,SKIM:LogError+LogErrorMonitor,EI,PAT --runUnscheduled --data --era Run2_2016 --scenario pp --conditions 80X_dataRun2_ICHEP16_repro_v0 --eventcontent AOD,MINIAOD --datatier AOD,MINIAOD --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016 --filein inputfile.root -n 500 --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    secondaryFileNames = cms.untracked.vstring("file:/pickevents_Robert_doubleMuon.root")
)
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RECO_RAW2DIGI_L1Reco_RECO_ALCA_SKIM_EI_PAT.root'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RECO_RAW2DIGI_L1Reco_RECO_ALCA_SKIM_EI_PAT_inMINIAOD.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.pathALCARECOMuAlCalIsolatedMu,process.pathALCARECOTkAlZMuMu,process.pathALCARECOMuAlOverlaps,process.pathALCARECOMuAlZMuMu,process.pathALCARECODtCalib,process.pathlogerror,process.pathlogerrormonitor,process.eventinterpretaion_step,process.Flag_HBHENoiseFilter,process.Flag_HBHENoiseIsoFilter,process.Flag_CSCTightHaloFilter,process.Flag_CSCTightHaloTrkMuUnvetoFilter,process.Flag_CSCTightHalo2015Filter,process.Flag_globalTightHalo2016Filter,process.Flag_globalSuperTightHalo2016Filter,process.Flag_HcalStripHaloFilter,process.Flag_hcalLaserEventFilter,process.Flag_EcalDeadCellTriggerPrimitiveFilter,process.Flag_EcalDeadCellBoundaryEnergyFilter,process.Flag_goodVertices,process.Flag_eeBadScFilter,process.Flag_ecalLaserCorrFilter,process.Flag_trkPOGFilters,process.Flag_chargedHadronTrackResolutionFilter,process.Flag_muonBadTrackFilter,process.Flag_trkPOG_manystripclus53X,process.Flag_trkPOG_toomanystripclus53X,process.Flag_trkPOG_logErrorTooManyClusters,process.Flag_METFilters,process.endjob_step,process.AODoutput_step,process.MINIAODoutput_step,process.ALCARECOStreamDtCalibOutPath,process.ALCARECOStreamMuAlCalIsolatedMuOutPath,process.ALCARECOStreamMuAlOverlapsOutPath,process.ALCARECOStreamMuAlZMuMuOutPath,process.ALCARECOStreamTkAlZMuMuOutPath,process.SKIMStreamLogErrorOutPath,process.SKIMStreamLogErrorMonitorOutPath)
