...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,ALCA:TkAlMuonIsolated+DtCalib+MuAlCalIsolatedMu+MuAlOverlaps+MuAlZMuMu+HcalCalIterativePhiSym,SKIM:ZMu+MuTau+LogError+LogErrorMonitor,EI,PAT --runUnscheduled --data --era Run2_2016 --scenario pp --conditions 80X_dataRun2_ICHEP16_repro_v0 --eventcontent AOD,MINIAOD --datatier AOD,MINIAOD --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016 --filein inputfile.root -n 500 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:///afs/hephy.at/work/e/easilar/rereco_study/CMSSW_8_0_13_patch1/src/make_rereco/pickEvents_3MuonEvents_RAW.root'),
